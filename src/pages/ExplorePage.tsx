...
const ExplorePage = () => {
    const apies : APICardProps[]= [
        ...
        },
        {
            ...
            price: "Paid",
            iconUrl: "string",
            description: "GPT-4o 등 텍스트 생성, 이미지 생성(DALL-E), 음성 인식을 지원하는 가장 핫한 AI API입니다.",
        },
        {
            id: 3,
            title: "Eleven Labs",
        ...
        },
        {
            ...
            price: "Paid",
            iconUrl: "string",
            description: "국내 특화 기능(로드뷰, 상세 주소 검색 등)이 강력해 한국 서비스 개발 시 필수입니다.",
        },
        {
            id: 5,
            title: "Mapbox",
            ...
            price: "Paid",
            iconUrl: "string",
            description: "커스텀 디자인 지도를 만들기에 최적화되어 있으며 시각적으로 세련된 앱에 많이 쓰입니다.",
        },
    ]
  ...
  return (
    <div className="mt-10">
        ...
        <div className="mt-8">
            ...
            <div className='mt-3 gap-10 grid grid-cols-1 
