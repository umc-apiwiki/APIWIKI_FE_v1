...
export const MobileHomePage = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-b from-blue-50 to-white pb-20">
      <MobileHeader />

      {/* 메인 컨텐츠 */}
      <main className="flex flex-col items-center justify-center min-h-[calc(100vh-140px)] px-4 pt-14">
        {/* 로고 */}
        <motion.div
          className="mb-6"
        ...
        >
          <img src="/logo.svg" alt="API Wiki Logo" className="w-20 h-20" />
        </motion.div>

        {/* 설명 텍스트 */}
        <motion.p
          className="text-center text-gray-700 text-base mb-6 leading-relaxed px-4"
        ...
        {/* 검색바 */}
        <motion.div
          className="w-full max-w-md mb-6 cursor-pointer"
        ...
        >
          <div className="flex items-center justify-between px-4 py-3 bg-white rounded-xl shadow-md border border-gray-200 hover:border-blue-500 transition-colors">
            <span className="text-gray-400 text-sm">궁금한 API를 검색해보세요</span>
