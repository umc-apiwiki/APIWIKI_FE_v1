...
export const MobileHeader = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full max-w-full bg-white/50 backdrop-blur-lg border-b border-gray-200/30 z-50 md:hidden mobile-safe-area-top">
      <div className="flex items-center justify-between px-3 xs:px-4 sm:px-5 h-12 xs:h-14 sm:h-16">
        ...
        <Link to="/" className="flex items-center gap-1.5 xs:gap-2">
          ...
          <span className="text-base xs:text-lg sm:text-xl font-bold text-blue-600">API Wiki</span>
        </Link>
      </div>
    </header>
  )
