      ...
      <div className="relative pl-8">
        ...
        <div className="flex gap-4 h-36">
          ...
          <div className='flex items-center justify-center flex-shrink-0'>
            <div
            className="w-[70px] h-[70px] rounded-[10px] overflow-hidden flex-shrink-0 bg-white border border-brand-500/50"
            >
                {/* 아이콘 이미지 */}
          ...
          <div className="flex flex-col justify-center pl-2">
            <h3
              className="text-[#071E31] font-medium leading-tight text-xl pb-2"
            >
              {title}
            </h3>
